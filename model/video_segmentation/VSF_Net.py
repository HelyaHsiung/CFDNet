...
from model.utils.VSFResNet3d import VSFResNet3d, VSFBasicBlock, BasicBlock
...
class VSF_Net(LightningModule):
    def __init__(self, settings: DictConfig):
        ...
        vsfresnet18_2d = VSFResNet3d(VSFBasicBlock, [2, 2, 2, 2], 32, self.time_steps)
        backbone = torch.nn.Sequential(*list(vsfresnet18_2d.children())[:-2])

        self.layer1 = nn.Sequential(*backbone[:4])
        self.layer2 = nn.Sequential(*backbone[4:6])
        self.layer3 = backbone[6]
        # self.CBAMLayer = CBAMLayer2d(512, reduction=4)
        self.layer4 = backbone[7]
        self.layer5 = backbone[8]
    ...
    def test_step(self, batch, batch_idx):
        ...
        save_dir = "E:/Python/MS_Gas_Segmentation/log/VSFNet-Gas-Segmentation/2024-12-09_19-27-00"
