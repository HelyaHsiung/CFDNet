...
from model.utils.TEARes2Net2d import TEARes2Net, Res2BlockShift
...
class TEA_Net(LightningModule):
    def __init__(self, settings: DictConfig):
        ...
        teares2net_2d = TEARes2Net(Res2BlockShift, [2, 2, 2, 2], 32, baseWidth=settings.model.baseWidth, scale=settings.model.scale)
        backbone = torch.nn.Sequential(*list(teares2net_2d.children())[:-1])
