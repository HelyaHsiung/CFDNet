...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, downsample=None):
        ...
        self.conv1_t = conv3x1x1(mid_planes1, planes, 1)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, downsample=None):
        ...
        self.conv2_t = conv3x1x1(mid_planes, planes, 1)
        self.bn2_t = nn.BatchNorm3d(planes)
...
class ResNet3d(nn.Module):
    def __init__(self,
        ...
        mid_planes = n_3d_parameters // n_2p1d_parameters
        self.conv1_s = nn.Conv3d(in_ch, mid_planes, kernel_size=(1, 7, 7), stride=(1, 2, 2), padding=(0, 3, 3), bias=False)
